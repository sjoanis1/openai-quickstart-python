...
#       print(prompt)
        ...
        prompt = "1.I search and validate information to identify the fire chief and website of a fire rescue organization and identify the current fire chief.  I provide the name, website, phone number and email address when they are available otherwise I answer not found."
